...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -shared -Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    '
              '-Wl,--build-id=sha1  -g  -Wl,-z,relro -Wl,--as-needed  '
              '-Wl,-z,now    -Wl,--build-id=sha1  -g',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_LDFLAGS_NODIST': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now '
                             ...
                             '-specs=/usr/lib/rpm/redhat/redhat-annobin-cc1  '
                             '-Wl,--build-id=sha1 '
                             '-Wl,-dT,/builddir/build/BUILD/Python-3.10.7/.package_note-python3.10-3.10.7-1.fc36.x86_64.ld '
 ...
 'CONFIG_ARGS': "'--build=x86_64-redhat-linux-gnu' "
                ...
                "-Wl,-z,now    -Wl,--build-id=sha1  -g ' 'CPPFLAGS=' "
                "'PKG_CONFIG_PATH=:/usr/lib64/pkgconfig:/usr/share/pkgconfig'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/builddir/build/BUILD/Python-3.10.7/build/optimized/coverage.info',
 'COVERAGE_REPORT': '/builddir/build/BUILD/Python-3.10.7/build/optimized/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/builddir/build/BUILD/Python-3.10.7/Include',
 'CXX': 'g++',
 ...
 'MAKESETUP': '/builddir/build/BUILD/Python-3.10.7/Modules/makesetup',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-fprofile-correction '
                             '-I/builddir/build/BUILD/Python-3.10.7/Include/internal '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                   ...
                   '-I/builddir/build/BUILD/Python-3.10.7/Include/internal '
                   '-IObjects -IInclude -IPython -I. '
                   '-I/builddir/build/BUILD/Python-3.10.7/Include -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    '
                    '-Wl,--build-id=sha1  -g  -Wl,-z,relro -Wl,--as-needed  '
                    '-Wl,-z,now    -Wl,--build-id=sha1  -g -Wl,-z,relro '
                    '-Wl,--as-needed  -Wl,-z,now '
                    '-specs=/usr/lib/rpm/redhat/redhat-hardened-ld '
                    '-specs=/usr/lib/rpm/redhat/redhat-annobin-cc1  '
                    '-Wl,--build-id=sha1 '
                    '-Wl,-dT,/builddir/build/BUILD/Python-3.10.7/.package_note-python3.10-3.10.7-1.fc36.x86_64.ld '
                    '-g  -fno-semantic-interposition -flto -fuse-linker-plugin '
 ...
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    '
               '-Wl,--build-id=sha1  -g  -Wl,-z,relro -Wl,--as-needed  '
               '-Wl,-z,now    -Wl,--build-id=sha1  -g',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.10.7/build/optimized',
 'SCRIPTDIR': '/usr/lib64',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'SRC_GDB_HOOKS': '/builddir/build/BUILD/Python-3.10.7/Tools/gdb/libpython.py',
 'STATIC_LIBPYTHON': 0,
 'STDC_HEADERS': 1,
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.10.7/build/optimized '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.10.7/build/optimized '
               './python '
               '/builddir/build/BUILD/Python-3.10.7/Tools/scripts/run_tests.py',
 ...
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': '/builddir/build/BUILD/Python-3.10.7/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 1,
 'VERSION': '3.10',
 'VPATH': '/builddir/build/BUILD/Python-3.10.7',
 ...
 'abs_builddir': '/builddir/build/BUILD/Python-3.10.7/build/optimized',
 'abs_srcdir': '/builddir/build/BUILD/Python-3.10.7',
 'datarootdir': '/usr/share',
 'exec_prefix': '/usr',
 'prefix': '/usr',
 'srcdir': '/builddir/build/BUILD/Python-3.10.7'}
